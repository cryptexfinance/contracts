...
abstract contract IRToken is RTokenStructs, IERC20 {
  ...
  function token() virtual external returns (IERC20);
  ...
  /**
    ...
    */
  function decimals() virtual external view returns (uint256);

  ////////////////////////////////////////////////////////////////////////////
  // For virtual external transactions
  ////////////////////////////////////////////////////////////////////////////
  /**
    ...
    */
  function mint(uint256 mintAmount) virtual external returns (bool);
  ...
  /**
    ...
    * @return bool true=success, otherwise a failure
    */
  function transferAll(address dst) virtual external returns (bool);
  ...
  /**
    ...
    * @return bool true=success, otherwise a failure
    */
  function transferAllFrom(address src, address dst) virtual external returns (bool);
  ...
  /**
    ...
    * @return bool true=success, otherwise a failure
    */
  function redeem(uint256 redeemTokens) virtual external returns (bool);

  /**
    * @notice Sender redeems all rTokens in exchange for the underlying asset
    * @return bool true=success, otherwise a failure
    */
  function redeemAll() virtual external returns (bool);
  ...
  /**
    ...
    * @return bool true=success, otherwise a failure
    */
  function redeemAndTransferAll(address redeemTo) virtual external returns (bool);
  ...
  /**
    ...
    * @return hatID uint256 of the newly creatd Hat.
    */
  function createHat(
      address[] calldata recipients,
      uint32[] calldata proportions,
      bool doChangeHat
  ) virtual external returns (uint256 hatID);
  ...
  /**
    ...
    * @return bool true=success, otherwise a failure
    */
  function changeHat(uint256 hatID) virtual external returns (bool);
  ...
  /**
    ...
    * inheritance scam".
    */
  function payInterest(address owner) virtual external returns (bool);
  ...
  /**
    ...
    */
  function getMaximumHatID() virtual external view returns (uint256 hatID);
  ...
  function ias() virtual external returns (IAllocationStrategy);
  ...
  function savingAssetConversionRate() virtual external returns (uint256);
  ...
  /**
    ...
    */
  function getCurrentSavingStrategy() virtual external view returns (address);
  ...
  * @return global stats
  */
  function getGlobalStats() virtual external view returns (GlobalStats memory);
